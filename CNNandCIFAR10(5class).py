...
label_folder = []
total_size = 0
data_path = r"C:\Users\win10\Desktop\code\python\NN\project2\CIFAR10_Test Image\Training_data"
...
#shuffile
data_num = len(base_x_train)
buffer = [[]for i in range(0,data_num)]
for i in range(0,data_num):
    buffer[i].append(base_x_train[i])
    buffer[i].append(base_y_train[i])
...
for i in range(0,data_num):
    base_x_train.append(buffer[i][0])
    base_y_train.append(buffer[i][1])


for i in range(0,5):
    print(base_x_train[i])
    print(base_y_train[i])
...
FilenameO = []
total_size = 0
data_pathO = r"C:\Users\win10\Desktop\code\python\NN\project2\CIFAR10_Test Image\Testing_data"
...
#test
answer =['airplane','automobile','cat','deer','bird','airplane','deer','bird','automobile','cat','airplane','automobile','cat','deer','bird','bird','deer','bird','automobile','cat','airplane','automobile','cat','deer','airplane','airplane','deer','bird','automobile','cat']
